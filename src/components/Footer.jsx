...
function Footer() {
    ...
    return (
        <>
            ...
            <div className="footer flex gap-6 md:gap-10 flex-wrap px-6 md:justify-around py-10 md:py-20 border-t border-zinc-600">
                <div>
                    <a href="#" className="font-sans text-white font-bold text-2xl">
                        <h2 className='text-2xl uppercase font-semibold'>Bookme<span className="lowercase">.in</span></h2>
                    </a>
